...
from ARCHI.Decoder import Decoder_NN
...
class SaMam(nn.Module):
    def __init__(self, nVSSMs=2,
        ...
        self.global_embedder = GlobalStyleEncoder(channels=embed_dim, representation_dim=representation_dim,embed_dim=embed_dim)

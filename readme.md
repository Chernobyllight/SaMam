...
All the test settings are provided in function "parse_args()" of the file "test_image.py". You can adapt them manually when you use trained model with your own model architecture setting.
